...
interface StyleInputProps {
  ...
  onAiEngineChange: (engine: 'ollama' | 'claude') => void
}

export default function StyleInput({ onAnalyze, aiEngine, onAiEngineChange }: StyleInputProps): JSX.Element {
  ...
  return (
    <div className="style-input">
      ...
      <div className="style-input__footer">
        ...
        <select
          className="style-input__engine-select"
          value={aiEngine}
          onChange={(e) => onAiEngineChange(e.target.value as 'ollama' | 'claude')}
        >
